...
<main class="main-content bgc-grey-100" id="divToPrint">
  <div id="mainContent">
    <div class="peer" style="float: right;">
      <a href="{!! asset('importJobs') !!}"><button class="btn btn-primary">Import</button></a>
      <a href="{!! asset('job_details/addNewJob') !!}"><button class="btn btn-primary">Add Job</button></a>
    </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
              <form action="{{ url('searchbycarbooking')}}" method="post"> Search By Booking Date: <input type="date" name="booking_date"> <input type="submit" value="search"></form><br/>
 ...
 <script>
    ...
    window.location.href='{!! asset("getcardetailsbylocations")!!}/'+id;
