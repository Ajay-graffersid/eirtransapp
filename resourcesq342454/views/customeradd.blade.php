      ...
      <div class="row gap-20 ">
        <div class="masonry-item col-md-7" style="">
          ...
          <h6 class="c-grey-900">Add Customer</h6>
            <div class="mT-30">
              <form method='post' action="{!! asset('/savecustomer') !!}" id="quickForm"> 
                <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                <div class="form-group row">             
                  <label for="customer_name" class="col-sm-2 col-form-label">Customer Name</label>
                  <div class="col-sm-10">
                    <input type="text" name="customer_name" class="form-control" id="customer_name" aria-describedby="emailHelp" placeholder="Enter name" required>
                  </div>      
                </div>   
                ...
                <div class="form-group row">             
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="password" class="form-control" id="password" aria-describedby="emailHelp" value="" placeholder="Enter name" required>
                  </div>    
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="collectionaddress" class="form-control" id="collectionaddress" aria-describedby="emailHelp" placeholder="Enter Address" required>
                  </div>
                </div>
