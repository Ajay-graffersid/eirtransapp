          ...
          <div class="row gap-20 ">
            <div class="masonry-item col-md-7" style=" ">
              ...
              <div class="bgc-white p-20 bd">
                ...
                <div class="mT-30">
                  <form method='post' action="{!! asset('job_details/updateJob') !!}" enctype="multipart/form-data">
                    {{csrf_field()}}
                      ...
                      <div class="col-sm-10">
                        <select id="customer_id" class="form-control" name="customer_id" required>
                           @foreach ($customers as $customer)
                            <option value="{{$customer->id}}" <?php if($jobs->customer == $customer->id){echo "selected";} ?> > {{$customer->customer_name}} </option>
                           @endforeach
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">    
                     ...
                     <div class="form-group row">    
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="model" class="form-control" value="{{$jobs->model}}" id="model" aria-describedby="emailHelp" required>
                      </div>
                    </div>
                      ...
                      <div class="col-sm-10">
                        <select id="lan" class="form-control" name="lan" required>
                          ...
                          @foreach ($lanes as $lane)
                            <option value="{{$lane->id}}" <?php if($jobs->lan == $lane->id){echo "selected";} ?> > {{$lane->lane_type}} </option>
                          @endforeach
                        </select>
                      </div> 
                    </div> 
                    ...
                    <div class="form-group row">    
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="relese_code" min="0" class="form-control" id="relese_code" aria-describedby="emailHelp"  value="<?php if(isset($jobs->relese_code)){echo $jobs->relese_code; }?>">
                      </div>
                    </div>
