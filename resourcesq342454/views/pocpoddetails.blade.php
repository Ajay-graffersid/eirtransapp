                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <?php
                            ...
                            //   $cus= DB::select("select *from cardetails where id=? && customer=? ",[$pods->cardetails_id,$login_id]);
                            // }else{
                     ...
                     @if(!empty($pods->deliver_date))
                        ...
                        <td><a href="{{ url('poc').'/'.$pods->cardetails_id }}"   class="view_btn cus-button">POC LINK</a></td>
                        ...
                        <td><input type="button" value="Email Client"  onclick="getplannerdetails({{$pods->cardetails_id}})" /></td>
                        <!--
                        href="{{ url('mailpocpod').'/'.$pods->cardetails_id}}"
