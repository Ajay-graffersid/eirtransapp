    ...
    <div class="row gap-20 ">
      <div class="masonry-item col-md-10" style=" ">
        ...
        <div class="bgc-white p-20 bd">
          <h6 class="c-grey-900">Import Csv</h6>
          <div class="mT-30">
            <div class="form-group row">    
              <label for="job_number" class="col-sm-2 col-form-label">Download Sample</label>
              <div class="col-sm-10">
                <a href="{{url('/assets/static/customer_csv.csv')}}" download><button type="button" class="btn btn-primary">Download</button> </a>
              </div>
            </div>
            <form method='post' action="{!! asset('importCustomerCsv') !!}" enctype="multipart/form-data">
              {{csrf_field()}}
