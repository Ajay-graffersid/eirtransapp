...
<main class="main-content bgc-grey-100" id="divToPrint">
      ...
      @endif
                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                                    ...
                                    <form action="{{ url('searchbarexpenses')}}" method="post"> Search By Expenses Date: <input type="date" name="datatime"> <input type="submit" value="search"></form>
                  ...
                  <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{ $sr++ }}</td>
                         <td><?php
                            $name = DB::table('driver')->where('id',$drexpence->driver_id)->first();
                             if(!empty($name))
                             {
                            echo $name->name;
                             }
