          ...
          <div class="container-fluid">
            <h4 class="c-grey-900 mT-10 mB-30">Load Builder</h4>
                 ...
                 <!--  <a href="{!! asset('car_for_delivery/list') !!}"><input type="button"  value="Car For Delivery"  disabled='disabled' class="dis_btns" style="background: #367f39 !important;"></a> -->
                      ...
                      <input type="button"  value="Car For Delivery"  disabled='disabled' class="dis_btns" style="background: #367f39 !important;" onclick="carfordeliverybutton()"> 
          ...
          <div class="left-inner-main custom-scrollbar-css">
              <div class="bgc-whitAe bdS bdrAs-3 p-20 mB-20 col-md-6a">
                     ...
                     <div class="btnnew" style="margin-bottom:25px;">
                               <select class="drop_her" id="lane_btn" onchange="carfordeliverybutton()">
                                   <option value="0">Select Lane </option>
                                   @foreach($lanes as $lane)
                                    <option value="{{$lane->id}}" @if($laneid==$lane->id) {{'selected'}} @endif  >{{$lane->lane_type}}</option>
                                 @endforeach
                               </select>
                  ...
                  <table id="dataTable" class="custom-scrollbar-css table-striped table-bordered" cellspacing="0" width="100%" style="height:auto;">
                    ...
                    <tbody class="{{$loadc->id}}">
                      ...
                      <tr id="{{$exp}}">
                         ...
                         <td><a href=" {{ URL('/removecardeliveryload/'.$loadc->id.'/'.$car_for_collection[0]->id)}}"><i style="font-size:10px" class="fa">&#xf00d;</i></a> @if(!empty($customernames)){{ $customernames[0]->customer_name }}@endif</td>
...
var percent = $("div.main-left").width() / $(".mainContent").width() * 100;
 ...
 <script>
  $('body').on('change','#lane_btn',function(){

    var lane = $(this).val();
    
  window.location.href='{!! asset("deliveryBuilderAjaxData")!!}/'+lane;
