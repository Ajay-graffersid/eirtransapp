                           ...
                           <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                              <div class="layers bd bgc-white p-20" style="background: #f6f7c9 !important;">
                                 <div class="layer w-100 mB-10">
                                     <a href="{{url('loadassigntodriver')}}"><h6 class="lh-1" style="font-size: 16px;">Today Planner</h6></a>
                                 </div>
                                 <div class="layer w-100">
                                    <div class="peers ai-sb fxw-nw">
                        ...
                        ?>
                             ...
                             @foreach ($todymorningchecks as $todymorningcheck)
                                      ...
                                      <td class="fw-600">{{ $sr++ }}</td>
                                             <td>{{$todymorningcheck->driver->name }}</td>
                                             <td>{{$todymorningcheck->driver->mobile }}</td>
                                              <td>{{$todymorningcheck->trucknumber }}</td>
                                              <td>{{$todymorningcheck->datetime }}</td>
