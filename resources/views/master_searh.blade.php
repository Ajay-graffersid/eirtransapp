                      ...
                      @foreach ($jobs as $job)
                        <tr>
                          ...
                          <td><?php                            
                            ...
                            ?>
                          @if(!empty($checkinv))<i class="fa fa-download" aria-hidden="true" onclick="getplannerdetails({{$job->id}})"></i>@endif
                         </td>
                          <td>
        ...
        $.ajax({
            ...
            success: function(dataResult){
                ...
                $.each(resultData,function(index,row){
                    ...
                    bodyData+="<tr>"
                    // bodyData+="<td>"+ i++ +"</td><td><a href="+'https://eirtransapp.com/public/uploads/new-inv/'+row.inv_file+" download="+row.inv_file+">"+row.inv_file+"</a></td>";
                    bodyData+="<td>"+ i++ +"</td><td><a href="+"{{asset("uploads/new-inv")}}"+'/'+row.inv_file+" download="+row.inv_file+">"+row.inv_file+"</a></td>";
                    bodyData+="</tr>";
