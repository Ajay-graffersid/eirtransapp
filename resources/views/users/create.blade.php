...
<main class="main-content bgc-grey-100">
  <div id="mainContent">
    ...
    <form method='post' action="{{route('users.store')}}" id="quickForm"> 
                ...
                <option value="{{$role}}"<?php if($role==$ro[0]){echo 'selected';} ?>>{{$role}} </option>
                  ...
                  <?php  }else{?>
                    ...
                    <option value="{{$role}}"<?php if($role=='Customer'){echo 'selected';} ?>>{{$role}} </option>
                <?php  }
                ...
                <div class="form-group row hd">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="longitude" class="form-control" id="longitude" aria-describedby="emailHelp" placeholder="longitude" required>
                  </div>
                </div>
                ...
                <div class="form-group row hd">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="latitude" class="form-control" id="latitude" aria-describedby="emailHelp" placeholder="latitude" required>
                  </div>
                </div>
