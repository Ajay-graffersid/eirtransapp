...
<main class="main-content bgc-grey-100">
      ...
      @endif
          <div class="container-fluid">
           ...
           <a href="{{url('loadbuilder-create') }}"><input type="button" class="dis_btnss" value="Car For Collection" disabled=''  style="background: #fb1100 !important;"></a>
           <!-- <a href="{{ url('loadbuilder-create')}}"><input type="button" class="dis_btn" value="Car For Collection" class="dis_btnsss" style="background: #fb1100 !important;"></a>  -->
                 <a href="{{ url('loadbuilder-for_delivery').'/'.'0' }}"><input type="button" class="dis_btn" value="Car For Delivery" class="dis_btnsss" style="background: #9AE89D !important;"></a> 
              <a href="{{ url('loadbuilder-pendingdeliverjob')}}"><input type="button" class="dis_btn" value="Pending Not Deliverd" class="dis_btnsss" style="background: #9AE89D !important;"></a>
